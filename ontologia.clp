...
(defclass CASILLA (is-a USER)
    (slot nombreJuego (type SYMBOL))
    (slot tipo (type SYMBOL)(allowed-values normal final espera movextra piedra)(default normal))
...
(defclass TURNO (is-a USER)
    (slot fase (type SYMBOL)(allowed-values cambioTurno tirada movimiento fin)) 
